...
# :, in the third {} formats with the comma and the .0f puts it to 0 decimal places
print("{} {} for about {:,.0f}!".format(year, name, cost))

# for loop ascending in 50s aligned and pushed 3 spaces to the right using :>3 inside the {}
